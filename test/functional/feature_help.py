...
"""Verify that starting wusion with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start wusion with -h for help text")
        ...
        self.log.info("Start wusion with -version for version information")
        ...
        self.log.info("Start wusiond with -fakearg to make sure it does not start")
