# Support for Output Descriptors in Wusion Core

Since Wusion Core v0.17, there is support for Output Descriptors. This is a
...
on Wusion's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Wusion Core wallets, a convenience function `combo` is
