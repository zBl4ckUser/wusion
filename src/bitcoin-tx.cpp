...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " wusion-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  wusion-tx [options] <hex-tx> [commands]  Update hex-encoded wusion transaction\n" +
            "or:     wusion-tx [options] -create [commands]   Create hex-encoded wusion transaction\n" +
            "\n";
