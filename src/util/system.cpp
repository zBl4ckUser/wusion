...
const char * const BITCOIN_CONF_FILENAME = "wusion.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Wusion";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Wusion";
#else
    // Unix
    return pathRet / ".wusion";
#endif
#endif
}
